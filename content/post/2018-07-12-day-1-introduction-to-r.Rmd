...
**Formal definition:** Vectors are one-dimension arrays that can hold numeric data, character data, or logical data.

**In other words**, a vector is a sequence (or set) of data points:
  
  For example, a **numeric** vector looks like this: _1, 2.1, -4, 6.8, 2, -1_. A **character** vector looks like this: _"Kabul", "India", "Boat", "5", "."_. A **logical** vector looks like this: _FALSE, TRUE, TRUE, FALSE, TRUE_.
...
character_vector <- c("Kabul", "India", "Boat", "5", ".")
...
**NOTE:** If one vector is shorter, the elements of shorter vector is _recycled_.
...
A <- c(1, 4, 2, 5, 2, 2)
B <- c(3, 3, 1)
A >= B # Vector B becomes c(3, 3, 1, 3, 3, 1)
```
...
![](/post/2018-07-12-day-1-introduction-to-r_files/and or.png){width=100%}
