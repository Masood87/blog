...
include_graphics("~/Documents/GitHub/learn-how-to-github/screenshots/create repository.png")
```
...
```{r echo=FALSE, out.width="100%"}
include_graphics("~/Documents/GitHub/learn-how-to-github/screenshots/copy clone url.png")
```
...
```{r echo=FALSE, out.width="100%"}
include_graphics("~/Documents/GitHub/learn-how-to-github/screenshots/set working directory.png")
```
...
```{r echo=FALSE, out.width="100%"}
include_graphics("~/Documents/GitHub/learn-how-to-github/screenshots/git clone.png")
```
...
```{r echo=FALSE, out.width="100%"}
include_graphics("~/Documents/GitHub/learn-how-to-github/screenshots/git add.png")
```
...
```{r echo=FALSE, out.width="100%"}
include_graphics("~/Documents/GitHub/learn-how-to-github/screenshots/git commit and push.png")
```
